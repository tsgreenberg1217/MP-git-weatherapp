...
public final class Fragment2Binding implements ViewBinding {
  ...
  private Fragment2Binding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView weatherRV) {
  ...
  public static Fragment2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.weatherRV;
      RecyclerView weatherRV = ViewBindings.findChildViewById(rootView, id);
      if (weatherRV == null) {
        break missingId;
      }

      return new Fragment2Binding((ConstraintLayout) rootView, weatherRV);
    }
