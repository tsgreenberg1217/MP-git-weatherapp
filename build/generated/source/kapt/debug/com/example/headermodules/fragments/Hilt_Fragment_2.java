...
public abstract class Hilt_Fragment_2 extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Fragment_2_GeneratedInjector) this.generatedComponent()).injectFragment_2(UnsafeCasts.<Fragment_2>unsafeCast(this));
    }
  }
